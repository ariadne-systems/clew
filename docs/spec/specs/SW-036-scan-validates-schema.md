...
- Implements [ARCH-007](ARCH-007-schema-core-is-what-clew-reads.md) — the pinned-core/project split this scan enforces.
- Generalizes [SW-031](SW-031-scan-spec-status.md) — reading and checking the status becomes one part of validating the schema.
- Holds [CON-031](CON-031-reject-schema-violation.md).
- Applies a schema only after it passes [CON-032](CON-032-validate-schema-before-use.md).
