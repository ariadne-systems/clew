...
- Defining spec sets — the matchers, exclusion (ignore) patterns, and partition/completeness rules — is the follow-on story `STR-012`. The frame here is set-aware (traceables carry their id, lens, and filename; the generator emits one set per spec set), so it is not precluded.

## Relations

**Realizes**

- [SW-012](../specs/SW-012-spec-command.md)
- [SW-013](../specs/SW-013-scan-traceables.md)
- [SW-014](../specs/SW-014-generate-traceables.md)
- [ARCH-003](../specs/ARCH-003-generator-interface.md)
- [CON-012](../specs/CON-012-generated-files-tool-owned.md)
