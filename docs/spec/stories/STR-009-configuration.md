...
- [SW-009](../specs/SW-009-read-configuration.md)
- [CON-005](../specs/CON-005-id-prefix-must-be-configured.md) (rewritten: a minted id's prefix must be a configured prefix)
