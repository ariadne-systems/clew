...
- [SW-037](../specs/SW-037-java-annotation-anchored-output.md)
- [SW-038](../specs/SW-038-discover-anchors-java.md)

**Related**

- Parallels [STR-014](STR-014-typescript-generator.md) — the same completion, for the Java target.
- Implements [ARCH-003](../specs/ARCH-003-generator-interface.md) and [ARCH-004](../specs/ARCH-004-generator-discovers-markers.md) for Java.
- Uses [ARCH-006](../specs/ARCH-006-pluggable-comment-finders.md) — Java comment identification through the shared C-family lexer.
- Builds on the skeleton generators from [STR-011](STR-011-spec-command.md).
