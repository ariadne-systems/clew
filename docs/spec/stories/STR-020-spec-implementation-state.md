...
- [SW-031 — The spec scan reads each spec's implementation state](../derived-specs/SW-031-scan-spec-status.md) — reads the `**Status**` field onto the scanned spec; absent means planned.
