...
- [SW-006 — Derive per-prefix high-water marks from existing artifacts](../derived-specs/SW-006-derive-high-water-marks.md)
- [SW-007 — The tool exposes an `init` command that delegates to core](../derived-specs/SW-007-init-command.md)
- [CON-009 — Reconciliation never lowers a high-water mark](../derived-specs/CON-009-reconcile-never-lowers.md)
