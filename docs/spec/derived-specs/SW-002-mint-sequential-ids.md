...
**Description**
In sequential mode, minting a type produces ids of the form `<PREFIX>-<number>`.
...
Minting type SW with a count of 3 from a fresh state yields SW-001, SW-002, SW-003 at the default padding of 3.
