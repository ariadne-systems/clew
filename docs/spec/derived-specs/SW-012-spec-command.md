...
**Description**
The tool exposes a `spec` command, invoked as `clew spec`, taking no positional arguments.
...
`clew spec` is a registered subcommand and runs with no positional arguments.
